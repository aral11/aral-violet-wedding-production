  ...
  try {
    ...
    if (photos && photos.length > 0) {
      ...
      console.log({
        ...
        hasValidData:
          firstPhoto.photo_data && firstPhoto.photo_data.startsWith("data:"),
        dataType: firstPhoto.photo_data
          ? firstPhoto.photo_data.substring(0, 20) + "..."
          : "no data",
    ...
    const testPhotoData =
      "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='100' height='100' viewBox='0 0 100 100'><rect width='100' height='100' fill='%23e8f5e8'/><circle cx='50' cy='50' r='25' fill='%234ade80'/><text x='50' y='55' text-anchor='middle' fill='white' font-size='12'>TEST</text></svg>";
